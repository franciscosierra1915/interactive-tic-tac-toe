...
export default class TicTacToe {
  ...
  _boardLine(x, y, z, xOffset, yOffset) {
    ...
    const boardLineMaterial = new THREE.MeshPhongMaterial({color: "#292828"});
  ...
  _hiddenTile(xOffset, yOffset) {
    ...
    const hiddenTileMaterial = new THREE.MeshBasicMaterial({opacity : 0, transparent: true});
  ...
  _getStrike(x, y, z) {
    ...
    const strikeMaterial = new THREE.MeshPhongMaterial({color: "#ffffff"});
  ...
  _addCross(xOffset, yOffset) {
    ...
    const crossMaterial = new THREE.MeshPhongMaterial({color: "#ff0000"});
  ...
  _addCircle(xOffset, yOffset) {
    const cylinderGeometry = new THREE.SphereGeometry( 6, 64, 32 );;
    const cylinderMaterial = new THREE.MeshPhongMaterial({color: "#006eff"});
